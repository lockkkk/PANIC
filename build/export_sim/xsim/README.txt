...
#
# Generated by export_simulation on Thu Apr 07 20:39:50 CDT 2022
#
################################################################################
...
'-reset_run' switch to the './packet_gen_parallel.sh' script.

./packet_gen_parallel.sh -reset_run
...
./packet_gen_parallel.sh -noclean_files

For more information on the script, please type './packet_gen_parallel.sh -help'.
